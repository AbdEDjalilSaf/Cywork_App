   ...
   <div className='w-full fixed headerFixed  overflow-x-hidden top-0'>
         <header className='py-4 border-b-[1px] border-[#d9d9d9] bg-white  justify-between px-10 overflow-x-hidden lg:py-7 lg:px-15 xl:pt-4 xl:pb-4 xl:px-20 flex items-center md:justify-between xl:justify-between lg:justify-between z-50'>
          ...
          <ul className='flex gap-10 items-center'>
            ...
            <li><Link  to='/Events' className='textBase font-semibold  {path===to ? active : "" }'>Events</Link></li>
...
<li className='block'><Link  to='/Events' className='textBaseTwo  font-semibold  {path===to ? Bactive : "" }  flex justify-between items-center'>Events<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="24" fill='#1877F2' height="24" ><path d="M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z"/></svg></Link></li>
